# Custom::Redshift::Table

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `custom-redshift-table.json`
2. Implement your resource handlers in `custom_redshift_table/handlers.py`
